...
//         window->setWindowTitle("Position Control");
...
//         auto createSliderLayout = [&](const QString &axis, QSlider *&slider, QPushButton *&enterButton) {
...
//             QLabel *valueLabel = new QLabel(QString("%1 position: 0").arg(axis));
...
//                 valueLabel->setText(QString("%1 position: %2").arg(axis).arg(value));
//             });
//         };
...
//         createSliderLayout("X", sliderX, enterButtonX);
//         createSliderLayout("Y", sliderY, enterButtonY);
//         createSliderLayout("Z", sliderZ, enterButtonZ);
...
//         QPushButton *launchXButton = new QPushButton("Launch X Tick Motors");
//         QPushButton *launchYButton = new QPushButton("Launch Y Tick Motor");
//         QPushButton *launchZButton = new QPushButton("Launch Z Tick Motor");
...
//         QPushButton *closeXButton = new QPushButton("Close X Tick Motors");
//         QPushButton *closeYButton = new QPushButton("Close Y Tick Motor");
//         QPushButton *closeZButton = new QPushButton("Close Z Tick Motor");
...
//         launchCloseXLayout->addWidget(launchXButton);
//         launchCloseXLayout->addWidget(closeXButton);

//         QHBoxLayout *launchCloseYLayout = new QHBoxLayout;
//         launchCloseYLayout->addWidget(launchYButton);
//         launchCloseYLayout->addWidget(closeYButton);

//         QHBoxLayout *launchCloseZLayout = new QHBoxLayout;
//         launchCloseZLayout->addWidget(launchZButton);
...
//         QObject::connect(closeXButton, &QPushButton::clicked, [this]() { terminatePositionTickNode(x_process_); });
//         QObject::connect(closeYButton, &QPushButton::clicked, [this]() { terminatePositionTickNode(y_process_); });
//         QObject::connect(closeZButton, &QPushButton::clicked, [this]() { terminatePositionTickNode(z_process_); });

//         // Set the layout and show the window
//         window->setLayout(mainLayout);
//         window->setFixedSize(500, 600);  // Adjusted size for more widgets
//         window->show();
...
//         if ((nodeName.contains("X") && x_process_ && x_process_->state() != QProcess::NotRunning) ||
//             (nodeName.contains("Y") && y_process_ && y_process_->state() != QProcess::NotRunning) ||
//             (nodeName.contains("Z") && z_process_ && z_process_->state() != QProcess::NotRunning)) 
//         {
...
//             x_process_ = process;
//         } else if (nodeName.contains("Y")) {
//             y_process_ = process;
//         } else if (nodeName.contains("Z")) {
//             z_process_ = process;
//         }
//     }
...
public:
    SliderNode() : Node("slider_node") {
        ...
        // Function to create a slider layout for each axis
        auto createSliderLayout = [&](const QString &axis, QSlider *&slider, QPushButton *&enterButton, int range) {
            slider = new QSlider(Qt::Horizontal);
        ...
        QSlider *sliderX, *sliderY, *sliderZ;
        QPushButton *enterButtonX, *enterButtonY, *enterButtonZ;
        createSliderLayout("X", sliderX, enterButtonX, 408240);
        createSliderLayout("Y", sliderY, enterButtonY, 336240);
        createSliderLayout("Z", sliderZ, enterButtonZ, 551232);
        ...
        QObject::connect(closeYButton, &QPushButton::clicked, [this]() { terminatePositionTickNode(y_process_); haltMotor("third_shaft_joint");});
        QObject::connect(resetYButton, &QPushButton::clicked, [this]() { launch_node("Reset_Home_Y");});
        QObject::connect(closeZButton, &QPushButton::clicked, [this]() { terminatePositionTickNode(z_process_); haltMotor("fourth_shaft_joint");});
